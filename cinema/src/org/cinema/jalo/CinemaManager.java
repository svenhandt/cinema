...
/**
 * This is the extension manager of the Cinema extension.
 */
public class CinemaManager extends GeneratedCinemaManager
{
	...
	{
		return (CinemaManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CinemaConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CinemaManager() // NOPMD 
	{
		LOG.debug("constructor of CinemaManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CinemaManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CinemaManager called, current tenant: {}", getTenant().getTenantID());
	}
