...
public class DefaultCinemaService implements CinemaService {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultCinemaService.class);
	...
	// Keep in mind that with Slf4j you don't need to check if debug is
	// enabled, it is done under the hood.
	...
	return DefaultCinemaService.class.getResourceAsStream("/cinema/sap-hybris-platform.png");
    }
